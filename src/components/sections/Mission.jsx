      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row items-center justify-between max-w-5xl mx-auto gap-8 md:gap-0">
          <div className="relative w-full md:w-auto">
            <div className="relative rounded-lg bg-[length:200%_200%] bg-gradient-to-r from-blue-500/30 via-blue-400/60 to-blue-500/30 p-[2px] animate-border-flow">
              <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-transparent via-blue-400/10 to-transparent animate-shine"></div>
              <div className="relative rounded-lg bg-black p-6 md:p-10">
