  ...
  return (
    <footer className="bg-black py-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-8 md:mb-16">
          <div className="flex items-center gap-4">
            <img 
              src={logo22}
              alt="Elite Aide Logo" 
              className="w-[180px] h-[45px] md:w-[220px] md:h-[55px] object-contain"
            />
          </div>
          
          <div className="flex gap-4 md:gap-8">
            <a href="#" className="text-[#384766] hover:text-blue-400">
              <svg className="w-10 h-10 md:w-[55px] md:h-[55px]" viewBox="0 0 81 81" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="#" className="text-[#384766] hover:text-blue-400">
              <svg className="w-10 h-10 md:w-[54px] md:h-[54px]" viewBox="0 0 81 81" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="mb-8 md:mb-12">
          <p className="text-gray-300 mb-4 text-lg md:text-2xl font-nunito font-medium leading-relaxed max-w-[570px]">
        ...
        <div className="flex justify-end">
          <div className="flex gap-6 md:gap-8 text-gray-400">
